...
gantt
    ...
    section 김유빈 (프론트엔드)
    제품 페이지 구조 설계   :fe18, 2024-07-30, 2d
    제품 상세 페이지        :fe19, 2024-08-01, 2d
    Nav 컴포넌트 개발       :fe20, 2024-08-04, 1d
    제품 이미지 관리        :fe21, 2024-08-05, 2d
    API 연동 및 테스트      :fe22, 2024-08-11, 2d
    제품 페이지 최적화      :fe23, 2024-08-13, 2d
...
## 👧🏻 **조은이**
### 🔎 메인 페이지
- **브랜드 맞춤 비디오**: 원본 영상을 글로시말차 브랜드 가치에 맞게 재편집 (edit: BE_심희현)
...
## 👧🏻 **김유빈**
### 🔎 제품 페이지 (김유빈)
- **제품 카탈로그**: 시그니처, 말차다구세트, 틴케이스
- **상세 정보**: 제품별 상세 설명, 이미지, 구성품
- **다국어 지원**: 제품명, 설명 한국어/영어 전환
- **구매 안내**: 매장 방문 및 온라인 주문 정보
