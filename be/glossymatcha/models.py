...
class Products(models.Model):
    ...
    short_description = models.CharField(max_length=500, blank=True, verbose_name="슬로건")
    short_description_en = models.CharField(max_length=500, blank=True, verbose_name="슬로건 (영어)")
    ...
    note = models.CharField(max_length=200, blank=True, verbose_name="제품 보증 문구")
    note_en = models.CharField(max_length=200, blank=True, verbose_name="제품 보증 문구 (영어)")
