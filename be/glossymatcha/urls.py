...
urlpatterns = [
    ...
    # Excel Export Views
    path('monthly-sales/export/', views.MonthlySalesExcelExportView.as_view(), name='monthly_sales_excel_export'), # 월별 매출 엑셀 내보내기
    path('yearly-sales/export/', views.YearlySalesExcelExportView.as_view(), name='yearly_sales_excel_export'),   # 연별 매출 엑셀 내보내기
]