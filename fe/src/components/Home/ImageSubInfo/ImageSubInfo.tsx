...
export const imageSubInfos: TypeImageSubInfo[] = [
  ...
  {
    title: "Enjoy Matcha",
    subTitle: '"제주에서 즐기는 특별한 맛"',
    contents: [
      "제주 오름, 말차 스트레이트, 말차 모히또, 앙 말차 버터 토스트, 보리 크림 말차 등",
      "카페 글로시 말차에서만 즐길 수 있는 다양한 말차 메뉴를 만나보세요.",
    ],
  ...
  },
  {
    ...
    subTitle: '"어떤 메뉴를 먹을지 고민되시나요?"',
    contents: [
      "오늘의 기분, 취향에 맞는 메뉴를 찾는 것은 어려운 일입니다.",
      "지금 여기서 당신의 취향에 딱 맞는 메뉴를 찾아 드립니다.",
    ],
    link: "/test",
    btnText: "테스트 바로가기",
  },
  ...
  return (
    <div className={styles.container}>
      ...
      {index !== 1 ? (
        ...
        <a href={imageSubInfos[index].link} className="btn-g" target="_blank">
          {imageSubInfos[index].btnText}
        </a>
      )}
    </div>
